    ...
    if (request.method === "GET" && url.pathname === "/master") {
      try {
        ...
        if (!rawText || !rawText.trim()) {
          return json({ success: false, error: "La libreria Master ricevuta è vuota" }, 500);
        }
        ...
        if (!Array.isArray(products)) {
          return json({ success: false, error: "Formato della libreria Master non valido" }, 500);
        }
    ...
    if (request.method === "POST" && url.pathname === "/master") {
      ...
      try {
        ...
        if (!Array.isArray(body.products)) {
          return json({ success: false, error: "Formato prodotti non valido" }, 400);
        }
